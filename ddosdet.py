# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 13:02:08 2021
...
g=["Logistic Regression","Random Forest","Support Vector Machine - linear","Support Vector Machine - poly","Support Vector Machine - rbf",
...
def master():
    if __name__=='__main__':
        while(1):
            warnings.filterwarnings("ignore")
            s=int(input("""\nDDOS attack Network Detection System
                    choose :
